...
The standard soccer field consists of  artificial turf mounted on a flat wooden base. The dimensions of the different field sizes are shown in table \ref{tab:field_dim}. 
More detailed technical drawings are provided in Appendix \ref{sec:technical_drawings} \todo{To be attached} to this document.
