...
\subsectionNoNumber{Vision and Mission Statement}
\label{sec:vision_and_mission}

%NB: This is the vision statement developed by the former SPL teams
...
\begin{itemize}
    ...
    \item A league that promotes research, 
...
In addition, the \leaguenameabbr aims to:
\begin{itemize}
    ...
    \item Drive the vision and direction of the rules to encourage good quality soccer between evenly matched teams.
\end{itemize}

\subsectionNoNumber{Core Vision and Requirements for Legal Standard Robot Platforms}
...
With the \leaguenameabbr vision in mind, the core characteristics for standard humanoid platforms used within the \leaguenameabbr are:
...
\begin{enumerate}
    ...
    \item Sufficiently small and affordable to reasonably allow teams to fund multiple robots and travel with them to competitions;
    \item Able to be programmed at a low level of control;
    \item Well-documented to enable effective use and development by teams.
\end{enumerate}

\subsectionNoNumber{Core Vision and Requirements for Constructed Robots}
...
\begin{enumerate}
	...
	\item Details about hardware and software of the robots are made available to teams and organizers to ensure a fair competition and encourage scientific exchange.
