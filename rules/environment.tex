...
A robot is considered \textit{inside} a region of the field if any part of its body is touching the ground inside the region or the boundary lines.
 It is considered \textit{outside} the region only when no part of its body is touching the ground inside the region or the boundary lines.
