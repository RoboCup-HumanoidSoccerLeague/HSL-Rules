...
To ensure a fair and proportionate competitive environment, the field dimensions, number of players and ball size will vary to align with the specific requirements of each division\footnote{See section \ref{sec:divisions} for more details.}.
...
Table \ref{tab:field_dim} shows the dimensions of the S-, M- and L-Fields and Figures \ref{fig:field_small}, \ref{fig:field_medium} and \ref{fig:field_large} show the diagram of the three soccer fields. Note that the Middle Division can be played on the S-Field or the M-Field, while the Large Division can be played on both the M-Field and the L-Field.
More detailed technical drawings are provided in Appendix \ref{sec:technical_drawings}.
...
The balls  for each division\footnote{The TCs will decide on only one ball per division that will be used by all teams during the 2026 competition.} are defined in Table \ref{tab:balls}.
...
Additional balls which meet the requirements of \ref{sec:ball-measurements} may be placed around the field of play and their use is under the referee’s control.