...
\subsection{Law 1 -- The Field of Play}
\label{sec:field}
...
More detailed technical drawings are provided in Section \ref{sec:technical_drawings} \todo{To be attached}.
...
A goal consists of two vertical posts equidistant from the corner {\color{red}flagposts} and joined at the top by a horizontal crossbar. 
\improvement{This references to a "flag post". We do not have flagposts in HSL. Remove this reference.}
