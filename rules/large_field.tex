...
\newcommand{\drawingScale}{0.006666}
...
\begin{tikzpicture}
  ...
  \tikzmath{
    ...
    \goalAreaLength=1.0;
    \goalAreaWidth=4.0;
    \penaltyAreaLength=3.5;
    \penaltyAreaWidth=7.0;
    \penaltyMarkDist=2.5;
    \penaltyMarkLength=0.15;
    \cornerArcRadius=1.0;
    \centerCircleDiameter=4.0;
    \fieldLineWidth=.12;
    \goalLineWidth=.2;
  ...
  % === ADDED: Annotation Basis for Corner Arc (Top Right) ===
  ...
  \annotation{(penaltyMarkR)}{(goalR)}{90}{0.25}{I}
  \annotation{(centerA1)}{(centerA2)}{45}{0.25}{J}
  \annotation{(fieldTL)}{(borderStripA1)}{0}{0.25}{K}
  \annotation{(fieldTL)}{(borderStripA2)}{-90}{0.25}{K}
  \annotation{(penaltyAreaLT1)}{(penaltyAreaLT2)}{90}{0.25}{G}
  \annotation{(penaltyAreaLT2)}{(penaltyAreaLT3)}{180}{0.25}{H}
  
  % === ADDED: Corner Arc Annotation (K) ===
  \annotation{(cornerArcMeasureStart)}{(fieldTR)}{90}{0.25}{L}
  % ========================================
\end{tikzpicture}
