...
\subsection{Law 5 -- The Human Officials}
\label{sec:referees}
...
\subsubsection{The head referee}
...
\subsubsection{The Assistant Referees}
...
\subsubsection{The GameController Operator}
...
\subsubsection{Equipment of the referees}
...
\subsubsection{Referee List for Friendly Games}
...
\subsubsection{The Robot Handlers}
...
\subsubsection{Humans allowed on the field}
...
\subsubsection{Referees after the match}
