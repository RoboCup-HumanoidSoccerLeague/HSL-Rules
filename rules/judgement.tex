...
Each match is controlled by a number of referees, who have the authority and the duty to enforce the rules of play and ensure the game proceeds smoothly before, during, and after the scheduled time.
The referees are the only humans permitted on the carpeted area (\ie the field and the border area).
...
\begin{itemize}
    \item enforces the rules
    \item controls the match in cooperation with the assistant referees and the GameController operator
    \item ensures that any ball used meets the requirements of Law ???
    \item ensures that the players' equipment meets the requirements of Law ???
    \item stops, suspends or abandons the match, at their discretion, for any infringements of the rules
    ...
    \item provides the appropriate authorities with a match report, which includes information on any disciplinary action taken against players and/or team officials and any other incidents that occurred before, during or after the match
\end{itemize}
