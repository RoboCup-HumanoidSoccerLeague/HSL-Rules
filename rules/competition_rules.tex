...
The teams assigned to referee a game are allowed to decide among themselves which roles each team will fulfill. It is advised that the head referee and the GameController operator come from the same team.
