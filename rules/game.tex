...
\begin{itemize}
    \item all players of the team \textit{not} taking the kickoff must be in their own half of the field of play and outside of the center circle,

    \item all players of the team taking the kickoff must be in their own half of the field or inside the center circle,

    \item at most one player of the kicking team may be outside its own half (it must still be inside the center circle). That player is designated as the kicking player for this kickoff.
\end{itemize}
...
\begin{itemize}
    ...
    \item if a kicking player was designated during the \textbf{set} state, that player \textit{must} take the kickoff. If a different player kicks the ball before the ball is in play, this is an offense and the kick-off is retaken,
...
\begin{itemize}
	\item the ball rebounds off the head referee or a assistant referee, the goalpost, or the crossbar, and remains inside the field of play (i.e., within the region bounded by the touchlines and goal lines)
