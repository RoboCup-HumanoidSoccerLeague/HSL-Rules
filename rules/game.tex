...
\textit{The 99 heading is a temporary ``hot fix" due to incorrect tex formatting (file would start with a sublaw heading). The proper positioning of the robot states rules will be discussed shortly.}
