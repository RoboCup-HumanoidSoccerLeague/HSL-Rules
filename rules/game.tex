...
\begin{itemize}
	\item the ball is outside the field of play (and its boundary lines)
...
\begin{itemize}
	\item the ball rebounds off a match official (head referee or assistant referee), the goalpost, or the crossbar, and remains inside the field of play (i.e., within the region bounded by the touchlines and goal lines)
...
A goal is scored when the entire ball passes over the goal line, between the goalposts and under the crossbar as defined in \ref{sec:inside_outside} (Definition of Inside and Outside),    
