...
\section{Ball Stop Rule}
\label{sec:ball_stop_rule}

If a game half were to extend longer than the allotted time due to an ongoing attack situation by a team, the half should end if:
\begin{itemize}
  \item The ball comes to a complete stop, or
  \item The ball leaves the field of play with no immediate continuation of play by other robots.
\end{itemize}
