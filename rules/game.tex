...
When a brief stop is called, all robots must safely come to a stop as quickly as possible, and then remain still and cease all motion, behaving as if in the \texttt{set} state. No locomotion is permitted, not even for getting up. Robots must respond to this signal immediately.
