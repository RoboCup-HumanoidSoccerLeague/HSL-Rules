...
A robot that damages the field, or poses a threat to spectator safety is removed from the field according to the standard penalty and receives a yellow card. In severe cases, the robot may receive a red card instead.
