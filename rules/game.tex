...
\begin{itemize}
  \item The defending goalkeeper must remain on its feet (it is not allowed to "dive") until the ball is touched by the kicking team or the penaltty kick is complete.
