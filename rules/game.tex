...
\subsubsection{Penalty Kick Extension}
...
\subsubsection{Dropped Ball}
\label{sec:dropped_ball}

\paragraph{Definition of Dropped Ball}
...
\paragraph{Offences and Sanctions}
\begin{itemize}
...
%moved up from below - maybe a duplicate of the section 'Dropped Ball' from above?
\subsubsection{Drop Ball}
\label{sec:drop_ball}
...
\subsubsection{Cautionable offenses}
...
\subsubsection{Aborting a Penalty}
...
\subsubsection{Penalties against Teams or Humans}
...
%moved up from below
\subsection{Law 14 -- Penalty Kick and Penalty Shoot-Out}
...
\subsection{Law 15 -- Kick-in / Throw-in}
\label{sec:kick_in}
