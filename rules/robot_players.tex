...
The GameController will communicate at \GameControllerPacketRate{} packets per second.
...
The robot can be equipped with active components that makes the robot to immediately stop all movements and assume a safe posture.
...
Manufacturer(s) of a standard platform robots may provide a remote emergency button (or functionality) as part of the operating procedures of the robot. Unless otherwise listed in \Cref{sec:approved-standard-platforms} these may be available at all times. 
