...
\begin{itemize}
	...
	\item The jersey number. Informing the referees before the game starts of which jersey number will act as a goalkeeper is considered a sufficient marking. The goalkeeper may use any of the allowed jersey numbers.
\end{itemize}
