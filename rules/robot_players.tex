...
The goalkeeper robot must be uniquely marked so that it can be easily distinguished from the other robots on the same team by the referees (e.g., the player number may serve as a distinguishing element).

The goalkeeper may use a distinct jersey color, either by wearing the team’s second kit or by introducing a third, clearly distinguishable color.
