...
\newcommand{\law}[2]{%
  ...
  \refstepcounter{lawtmp}% % creates a unique anchor each time (for hyperlinks)
...
% this has been changed from the previous version b/c \ref and \cref were not working properly.
% This specific snippet was generated with assistance from an LLM..
\newcommand{\sublaw}[1]{%
  \par
  \stepcounter{subsubsection}%
  \renewcommand{\thelawtmp}{\thesubsection.\arabic{subsubsection}}%
  \refstepcounter{lawtmp}%
  \subsubsection*{§~\thelawtmp\quad #1}%
  \addcontentsline{toc}{subsubsection}{%
    \protect\numberline{}§~\thelawtmp\quad #1%
  }%
}

\renewcommand{\theparagraph}{§~\thesubsection.\arabic{subsubsection}.\arabic{paragraph}}
...
\include{rules/competition_rules}
\newpage
