...
\newcommand{\LeagueEmail}{robocup-humanoid@lists.robocup.org}

% Free Kick variables
\newcommand{\FreeKickTime}{45} % seconds to complete a free kick
...
\newcommand{\StandardPenaltyTime}{45} % seconds
\newcommand{\StandardPenaltyIncrease}{10} % seconds added for each subsequent penalty
\newcommand{\InPlacePenaltyTime}{15} % seconds
\newcommand{\ReadyDelayTime}{10} % seconds delay after whistle before GameController playing signal
\newcommand{\ReadyPhaseDuration}{45} % seconds for ready phase duration
\newcommand{\PenaltyKickSetupTime}{45} % seconds for penalty kick setup
