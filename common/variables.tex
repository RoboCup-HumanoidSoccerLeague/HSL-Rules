...
\newcommand{\FallenRobotPenaltyTime}{45} % seconds removal penalty
...
\newcommand{\UDPPacketLimit}{12000} % packets per half
\newcommand{\UDPPacketSize}{512} % bytes
\newcommand{\UDPDebugPacketRate}{1} % packet per second per robot
\newcommand{\GameControllerPacketRate}{1} % packets per second
