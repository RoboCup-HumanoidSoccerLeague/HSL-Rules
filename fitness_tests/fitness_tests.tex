...
The run ends when the robot entirely crosses the opposite goal line. The attempt also ends if the robot falls and is unable to get up within \FallenRobotGetUpTime~seconds or if the total duration of the attempt exceeds one minute (as determined by ``Scoring'' below).
